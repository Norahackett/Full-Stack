...
import { testTraillists, testTrails, ulster, lenister, munster, testUsers } from "../fixtures.js";
...
suite("Trail Model tests", () => {
  ...
  test("create multiple trailApi", async () => {
    const trails = await db.traillistStore.getTraillistById(ulsterList._id);
